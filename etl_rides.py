...
for file in os.listdir(unzipped):
    if file.endswith(".csv") and file not in processed:
        ...
        if miss_end > 0:
            ...
            print(f'{miss_end} rides were dropped due to missing end station id.')
        ...
        # Building station info code has been commented out and replaced with the code found in etl_station_city.py
